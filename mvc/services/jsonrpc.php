    ...
    */
    ...
    if (!$input) {
      if ($GLOBALS['HTTP_RAW_POST_DATA'] == "") {
        echo self::response(null, 0, array("code"=> -32700,
      ...
      $method = self::get_field($input, 'method', null);
      $params = self::get_field($input, 'params', null);
      $id = self::get_field($input, 'id', null);
      ...
      if (!($method && $id)) {
        ...
        echo self::response(null, $id, array("code" => -32600,
