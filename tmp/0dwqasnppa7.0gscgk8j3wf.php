		...
		<div class="row">
			...
			<div class="span9">
				<div class="span9 well">
				   <div id="postEditor" style="height: 600px; margin-bottom: 20px;"></div>
				   <a href="#" role="button" class="btn btn-primary" id="saveButton">Save</a>
				   <form class="hide" id="postForm" method="POST">
				   		<textarea id="postBody" name="postBody"><?php echo $originalPost; ?></textarea>
				   </form>
				</div>
			</div>
		</div><!--/row-->
...
<!-- Modal -->
	...
	<script>
	var opts = {
		container: 'postEditor',
		basePath: '../ui'
	};
	var editor = new EpicEditor(opts).load();

	editor.importFile('editPost',$('#postBody').val());
